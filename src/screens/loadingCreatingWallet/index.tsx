...
const STEPS: { title: string; step: number }[] = [
  { title: i18n.t('screens.loadingImport.1'), step: 25 },
  { title: i18n.t('screens.loadingImport.2'), step: 50 },
  { title: i18n.t('screens.loadingImport.3'), step: 75 },
  { title: i18n.t('screens.loadingImport.4'), step: 100 },
];

export const LoadingImport = () => {
  ...
  return (
    <AppLayout barStyle={'light-content'}>
      <View style={styles.wrapper}>
        ...
        <SFlex flexDirection={'column'} alignItems={'flex-start'} gap={16}>
